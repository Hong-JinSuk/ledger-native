...
const NAV: NavItem[] = [
  ...
  { href: '/insights', label: 'Insights', Icon: BarChart2, isActive: (p) => p.startsWith('/insights') },
  ...
  return (
    <View className="border-b border-line bg-paper">
      <View
        ...
        <Text className="text-2xl text-ink font-serif">Ledger</Text>
            ...
            return (
              <Link key={href} href={href} asChild>
                <Pressable
                  ...
                  <Icon size={15} color={active ? Palette.ink : Palette.muted} />
                  <Text
                    className={`text-xs uppercase tracking-wider ${
                      active ? 'text-ink font-sans-bold' : 'text-muted font-sans-semibold'
                    }`}>
                    {label}
                  </Text>
                </Pressable>
